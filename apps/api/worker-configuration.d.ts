/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fc76be7fc3e91f7e9a4e0e8cc11df885)
...
interface __BaseEnv_Env {
	...
	GARAGE_DO: DurableObjectNamespace<import("./src/index").GarageDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GarageDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "RESEND_API_KEY" | "AUTH_EMAIL_FROM">> {}
}
